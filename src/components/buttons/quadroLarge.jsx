...
export default function ButtonQuadroLarge({ isActive }) {
    return (
        <>
        <Link href="/pages/frame" className={`flex items-center text-sm gap-4 p-[6px] rounded-[4px] border ${isActive === true ? 'bg-[#374357] hover:bg-[#374357]' : 'hover:bg-[#374357]'} border-[#374357] cursor-pointer duration-[100ms]`}>
